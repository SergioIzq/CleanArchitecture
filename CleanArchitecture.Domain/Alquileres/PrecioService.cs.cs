...
public class PrecioService
{
    public PrecioDetalle CalcularPrecio(Vehiculo vehiculo, DateRange periodo)
    {
        ...
        var precioPorPeriodo = new Moneda(periodo.CantidadDias * vehiculo.Precio.Cantidad, tipoMoneda);
        ...
        if (porcentageChange > 0)
            accesorioCharges = new Moneda(precioPorPeriodo.Cantidad * porcentageChange, tipoMoneda);
